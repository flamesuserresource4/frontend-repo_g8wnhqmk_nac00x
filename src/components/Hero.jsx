...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-black">
      {/* Soft radial gradient accent that doesn't block Spline interactions */}
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-24">
        <div className="grid items-center gap-10 md:grid-cols-2">
          ...
          <div className="text-center md:text-left">
            <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-white/80 md:mx-0">
            ...
            <p className="mx-auto mt-5 max-w-xl text-base text-white/70 md:mx-0 md:text-lg">
            ...
            <div className="mt-10 flex items-center justify-center gap-6 text-sm text-white/60 md:justify-start">
          ...
          {/* Spline 3D Scene */}
          <div className="relative h-[360px] w-full rounded-xl border border-white/10 bg-white/5 shadow-[0_0_0_1px_rgba(255,255,255,0.06)] md:h-[520px]">
            <Spline
              scene="https://prod.spline.design/41MGRk-UDPKO-l6W/scene.splinecode"
              style={{ width: '100%', height: '100%' }}
            />
            {/* Subtle top gradient for depth, non-interactive */}
